...
employees_list = User.objects.select_related('profile','skills').filter(is_superuser=False,is_active=True).order_by('last_name','first_name','profile__workplace','profile__department')
